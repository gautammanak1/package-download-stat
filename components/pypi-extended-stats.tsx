    ...
    <div className="space-y-6">
          ...
          >
            <Card className="border-2 shadow-lg">
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mt-2">Since package launch</p>
              </CardContent>
            </Card>
          </motion.div>
        )}
          ...
          >
            <Card className="border-2 shadow-lg">
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mt-2">{new Date().getFullYear()}</p>
              </CardContent>
            </Card>
          </motion.div>
        )}
        ...
        >
          <Card className="border-2 shadow-lg">
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300} className="min-h-[250px]">
                <BarChart
                  data={topDatesThisMonthChartData}
                  margin={{ top: 5, right: 10, left: 0, bottom: 5 }}
                >
                  <CartesianGrid strokeDasharray="3 3" className="stroke-muted opacity-50" />
                  <XAxis
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {stats.topCountries &&
          ...
          topCountriesChartData.length > 0 && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Card className="border-2 shadow-lg" data-chart="top-countries">
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    Downloads by country in {new Date().getFullYear()}
                  </CardDescription>
                </CardHeader>
                  ...
                  <ResponsiveContainer width="100%" height={300} className="min-h-[250px]">
                    <PieChart>
                      ...
                      <Pie
                        ...
                        activeIndex={
                          activeCountry
                            ? topCountriesChartData.findIndex(
                        ...
                        <Label
                          content={({ viewBox }) => {
                            if (viewBox && "cx" in viewBox && "cy" in viewBox && activeCountry) {
                              const activeData = topCountriesChartData.find(
                                (item) => item.country === activeCountry
                              );
                              if (activeData) {
                                return (
                    ...
                    {topCountriesChartData.map((item, index) => (
                      <button
                        ...
                        className={`w-full flex items-center justify-between text-sm p-2 rounded-lg transition-colors ${
                          activeCountry === item.country ? "bg-muted" : "hover:bg-muted/50"
                        }`}
                      >
